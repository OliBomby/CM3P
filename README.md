...
A bunch of precomputed beatmap embeddings can be found [in this dataset on Hugging Face](https://huggingface.co/datasets/OliBomby/CM3P-Embeddings-244K).
Embeddings from this dataset or those generated by `extract_beatmap_embeddings.py` can be visualized on [this static visualizer website](https://olibomby.github.io/CM3P/).

Instructions on how to add your own beatmaps to the visualization are WIP.
